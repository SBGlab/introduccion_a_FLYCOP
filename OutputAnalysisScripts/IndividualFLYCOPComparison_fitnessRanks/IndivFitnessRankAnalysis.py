...
EXPECTED INPUT
    ...
    'configurationsResults_Scenario0_analysis.xlsx' from "OutputParametersAnalysis.py" script (OutputAnalysis) for the particular FLYCOP run to be considered OR
    other excel (dataframe) suitable file
