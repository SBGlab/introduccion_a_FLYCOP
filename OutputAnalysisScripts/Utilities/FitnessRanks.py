...
def describe_fitness_ranks(rank_limits_set, dataframe, descr_columns, ref_column):
    ...
    # 'SAVE STATS' version, in wanted to be stored in a file
    """
...
# -----------------------------------------------------------------------------
# Currently: specific to E.coli-P.putidaKT configuration:
...
# EXTRACT RATIOS OF INPUT PARAMETERS FOR FLYCOP run (configuration) as a single str line
# -----------------------------------------------------------------------------
# Currently: specific to E.coli-P.putidaKT configuration, with NP_uptake rates
...
def extract_ratios_NP(string_line_config):
    ...
    return uptake_ratio, initbiomass_ratio, NH4_Ec_KT, Pi_Ec_KT
# -----------------------------------------------------------------------------
...
def extract_baseConfig_NP(string_line_config):
    ...
    return sucr_ur, frc_ur, Ec_init, KT_init, NH4_Ec, NH4_KT, Pi_Ec, Pi_KT
# -----------------------------------------------------------------------------
