...
DESCRIPTION
    ...
    Currently adapted to: E.coli-P.putidaKT naringenin production corsortium (2 microbes).
...
NOTE THAT:
        ...
        Moreover, it is currently adapted to the consortium for naringenin production, E.coli-P.putidaKT (2 microbes).
